    ...
    <div class="container-md">
        <div class="row">
            <div class="col-md-6 text-center">
                ...
                <p class="text-ff fs-3">Un salon de coiffure différent, où l’on se sent comme chez soi. <br />
                Le professionnalisme et les conseils d’une équipe de coiffeurs passionnés <br />
                Une coupe qui révèle votre personnalité et vous donne le sourire !</p>
            </div>
            <div class="col-md-6">
